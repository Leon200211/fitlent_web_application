...
<div class="main_body">
    ...
    <div class="main_info" style="margin-left: 200px;">
        ...
        <h1> Изменение структуры столбца <?= $column ?> в таблице: <?=$table?><br>Из базы данных <?= $db ?> </h1>
        ...
        <div>
            <a href="table_structure.php?db=<?= $db ?>&table=<?=$table?>">Назад</a>
        </div>
        ...
        <form action="table_structure_update_main.php" method="post">
        <div>
        <table border="1">
            <tr>
                <th> Имя </th>
            ...
            <?php
            $sql_2 = "SELECT * FROM information_schema.`COLUMNS` 
            ...
            ?>
                ...
                <tr>
                    <td><input type="text" id="column_name" name="column_name" value="<?=$row_2['COLUMN_NAME']?>"></td>
                    <td>
                        <select name="type" id="type">
                            <option value="<?=$row_2['DATA_TYPE']?>">Выбранно: <?=$row_2['DATA_TYPE']?></option>
                    ...
                    <td><input type="text" id="Length/Values" name="Length/Values" value="<?=$row_2['CHARACTER_MAXIMUM_LENGTH']?>"></td>



                    <script type="text/javascript">
                        function Default_test() {
                            var social = document.getElementById("default");
                    ...
                    <td>
                        <select name="default" id="default" onchange=Default_test()>
                        ...
                        <?php
                        echo $row_2['COLUMN_DEFAULT'];
                        if(isset($row_2['COLUMN_DEFAULT'])){
                            ?>
                            <input type="text" placeholder="Введите ссылку" id="default_show" name="default_show" value="<?=$row_2['COLUMN_DEFAULT']?>">
                            <?php
                        }else {
                            ?>
                            <input type="text" placeholder="Введите ссылку" id="default_show" name="default_show" class="Default_test" value="<?=$row_2['COLUMN_DEFAULT']?>">
                            <?php
                        }
                        ?>
                    </td>
                    ...
                    <td>
                        <select lang="en" dir="ltr" name="comparison" id="comparison">
                            <option value="<?=$row_2['COLLATION_NAME']?>">Выбрано: <?=$row_2['COLLATION_NAME']?></option>
                            <option value=""></option>
                    ...
                    <td>
                        ...
                        <select name="attribute" id="attribute">
                            <option value="<?=$attribute?>">Выбрано: <?=$attribute?></option>
                            <option value=""></option>
                            <option value="BINARY">BINARY</option>
                    ...
                    <?php
                    if($row_2['COLUMN_DEFAULT'] == NULL){
                        ?>
                        <td><input type="checkbox" id="Null" name="Null" checked><label></label></td>
                    <?php
                    }else {
                        ?>
                        <td><input type="checkbox" id="Null" name="Null"><label></label></td>
                    <?php
                    }
                    ?>
                    ...
                    <?php
                    if(!empty($row_2['EXTRA'])){
                        ?>
                        <td><input type="checkbox" id="A_I" name="A_I" checked><label></label></td>
                        <?php
                    }else{
                        ?>
                        <td><input type="checkbox" id="A_I" name="A_I"><label></label></td>
                        <?php
                    }
                    ?>
                    ...
                    <td><input type="text" id="comment" name="comment" value="<?=$row_2['COLUMN_COMMENT']?>"></td>
            ...
            <input name="table_name" value="<?= $table ?>" hidden>
